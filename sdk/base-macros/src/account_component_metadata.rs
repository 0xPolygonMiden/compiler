...
fn schema_type_from_storage_type_arg(ty: &syn::Type) -> SchemaType {
    ...
    match last_segment.ident.to_string().as_str() {
        ...
        "u16" => SchemaType::u16(),
        "u32" => SchemaType::u32(),
        // TODO(i1352): a `StoredProcedure` slot lands here and is described as a plain word; flip
        // it to miden::protocol::stored_procedure once the protocol registers that schema type
