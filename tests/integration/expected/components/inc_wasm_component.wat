(component
  ...
  (core module (;0;)
    ...
    (func $inc_wasm_component::bindings::__link_custom_section_describing_imports (;2;) (type 1))
    ...
    (func $__rust_realloc (;4;) (type 2) (param i32 i32 i32 i32) (result i32)
      (local i32)
      block ;; label = @1
        i32.const 1048584
        local.get 2
    ...
    (func $inc (;5;) (type 3) (param i32) (result i32)
      call $wit_bindgen_rt::run_ctors_once
      local.get 0
      i32.const 1
      call $inc_wasm_component::bindings::miden::add_package::add_interface::add::wit_import
    )
    (func $wit_bindgen_rt::cabi_realloc (;6;) (type 2) (param i32 i32 i32 i32) (result i32)
      block ;; label = @1
        block ;; label = @2
          block ;; label = @3
            local.get 1
    ...
    (func $wit_bindgen_rt::run_ctors_once (;7;) (type 1)
      block ;; label = @1
        i32.const 0
    ...
    (func $wee_alloc::alloc_first_fit (;8;) (type 4) (param i32 i32 i32) (result i32)
    ...
    (func $<wee_alloc::WeeAlloc as core::alloc::global::GlobalAlloc>::alloc (;9;) (type 4) (param i32 i32 i32) (result i32)
      (local i32 i32 i32)
    ...
    (func $<wee_alloc::WeeAlloc as core::alloc::global::GlobalAlloc>::dealloc (;10;) (type 5) (param i32 i32 i32 i32)
      (local i32 i32 i32 i32 i32 i32 i32)
      block ;; label = @1
        local.get 1
        i32.eqz
    ...
    (func $cabi_realloc (;11;) (type 2) (param i32 i32 i32 i32) (result i32)
      local.get 0
      local.get 1
      local.get 2
      local.get 3
    ...
    (elem (;0;) (i32.const 1) func $inc_wasm_component::bindings::__link_custom_section_describing_imports $cabi_realloc)
