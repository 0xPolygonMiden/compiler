(component
  ...
  (core module (;0;)
    ...
    (func $__rust_alloc (;2;) (type 0) (param i32 i32) (result i32)
      i32.const 1048580
      local.get 1
      local.get 0
    ...
    (func $inc (;4;) (type 3) (param i32) (result i32)
    ...
    (func $wit_bindgen_rt::run_ctors_once (;6;) (type 1)
      block ;; label = @1
        i32.const 0
    ...
    (func $wee_alloc::alloc_first_fit (;7;) (type 4) (param i32 i32 i32) (result i32)
    ...
    (func $<wee_alloc::WeeAlloc as core::alloc::global::GlobalAlloc>::alloc (;8;) (type 4) (param i32 i32 i32) (result i32)
      (local i32 i32 i32)
    ...
    (func $<wee_alloc::WeeAlloc as core::alloc::global::GlobalAlloc>::dealloc (;9;) (type 5) (param i32 i32 i32 i32)
      (local i32 i32 i32 i32 i32 i32 i32)
      block ;; label = @1
        local.get 1
        i32.eqz
