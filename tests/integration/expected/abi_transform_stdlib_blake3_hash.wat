(module $abi_transform_stdlib_blake3_hash.wasm
  ...
  (import "miden:core-import/stdlib-crypto-hashes@1.0.0" "blake3-hash-one-to-one" (func $miden_stdlib_sys::stdlib::crypto::hashes::extern_blake3_hash_1to1 (;0;) (type 0)))
