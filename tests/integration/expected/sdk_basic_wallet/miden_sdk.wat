(component
  (core module (;0;)
    ...
    (func $wee_alloc::alloc_first_fit (;6;) (type 6) (param i32 i32 i32) (result i32)
    ...
    (func $<wee_alloc::WeeAlloc as core::alloc::global::GlobalAlloc>::alloc (;7;) (type 6) (param i32 i32 i32) (result i32)
      (local i32 i32 i32)
    ...
    (func $<wee_alloc::WeeAlloc as core::alloc::global::GlobalAlloc>::dealloc (;8;) (type 7) (param i32 i32 i32 i32)
      (local i32 i32 i32 i32 i32 i32 i32)
      block ;; label = @1
        local.get 1
        i32.eqz
