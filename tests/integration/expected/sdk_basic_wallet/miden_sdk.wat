(component
  ...
  (component (;0;)
    ...
    (type (;15;) (record (field "inner" 6)))
    (export (;16;) "nonce" (type 15))
    (type (;17;) (record (field "inner" 8)))
    (export (;18;) "account-hash" (type 17))
    (type (;19;) (record (field "inner" 8)))
    (export (;20;) "block-hash" (type 19))
    (type (;21;) (record (field "inner" 8)))
    (export (;22;) "storage-value" (type 21))
    (type (;23;) (record (field "inner" 8)))
    (export (;24;) "storage-root" (type 23))
    (type (;25;) (record (field "inner" 8)))
    (export (;26;) "account-code-root" (type 25))
    (type (;27;) (record (field "inner" 8)))
    (export (;28;) "vault-commitment" (type 27))
    (type (;29;) (func (param "felt" 6) (result 10)))
    (export (;1;) "account-id-from-felt" (func 0) (func (type 29)))
  )
