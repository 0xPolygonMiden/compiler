(component
  (core module (;0;)
    ...
    (func $__rust_alloc (;0;) (type 0) (param i32 i32) (result i32)
      (local i32)
      local.get 0
      local.get 1
      call $__rdl_alloc
    ...
    (func $__rust_realloc (;1;) (type 1) (param i32 i32 i32 i32) (result i32)
      (local i32)
      local.get 0
      local.get 1
      local.get 2
    ...
    (func $__rdl_alloc (;2;) (type 0) (param i32 i32) (result i32)
      (local i32)
      block ;; label = @1
        block ;; label = @2
          local.get 1
    ...
    (func $__rdl_realloc (;3;) (type 1) (param i32 i32 i32 i32) (result i32)
      (local i32 i32)
      block ;; label = @1
        block ;; label = @2
          block ;; label = @3
    ...
    (func $malloc (;4;) (type 2) (param i32) (result i32)
      local.get 0
      call $dlmalloc
    )
    (func $dlmalloc (;5;) (type 2) (param i32) (result i32)
    ...
    (func $free (;6;) (type 3) (param i32)
      local.get 0
      call $dlfree
    )
    (func $dlfree (;7;) (type 3) (param i32)
    ...
    (func $realloc (;8;) (type 0) (param i32 i32) (result i32)
      (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
      block ;; label = @1
        local.get 0
        br_if 0 (;@1;)
    ...
    (func $dispose_chunk (;9;) (type 4) (param i32 i32)
    ...
    (func $internal_memalign (;10;) (type 0) (param i32 i32) (result i32)
    ...
    (func $aligned_alloc (;11;) (type 0) (param i32 i32) (result i32)
      block ;; label = @1
        local.get 0
        i32.const 16
        i32.gt_u
    ...
    (func $abort (;12;) (type 5)
      unreachable
      unreachable
    )
    (func $sbrk (;13;) (type 2) (param i32) (result i32)
      block ;; label = @1
        local.get 0
        br_if 0 (;@1;)
        memory.size
    ...
    (func $memcpy (;14;) (type 6) (param i32 i32 i32) (result i32)
    ...
    (func $cabi_realloc (;15;) (type 1) (param i32 i32 i32 i32) (result i32)
      block ;; label = @1
        block ;; label = @2
          block ;; label = @3
            local.get 1
