(component
  ...
  (type (;4;)
    (instance
      ...
      (type (;6;) (own 1))
      (type (;7;) (func (param "asset" 6) (result 6)))
      (export (;0;) "add-asset" (func (type 7)))
      (export (;1;) "remove-asset" (func (type 7)))
      (type (;8;) (func (param "asset" 6) (param "tag" 3) (param "recipient" 5)))
      (export (;2;) "create-note" (func (type 8)))
    )
  )
  ...
  (core module (;0;)
    ...
    (import "miden:base/types@1.0.0" "[resource-drop]asset" (func $<basic_wallet::bindings::miden::base::types::Asset as wit_bindgen::WasmResource>::drop::drop (;1;) (type 1)))
    (import "miden:base/tx-kernel@1.0.0" "remove-asset" (func $basic_wallet::bindings::miden::base::tx_kernel::remove_asset::wit_import (;2;) (type 0)))
    (import "miden:base/tx-kernel@1.0.0" "create-note" (func $basic_wallet::bindings::miden::base::tx_kernel::create_note::wit_import (;3;) (type 2)))
    (func $__wasm_call_ctors (;4;) (type 3))
    (func $miden:basic-wallet/basic-wallet@1.0.0#receive-asset (;5;) (type 1) (param i32)
      call $wit_bindgen::rt::run_ctors_once
      local.get 0
      call $basic_wallet::bindings::miden::base::tx_kernel::add_asset::wit_import
      call $<basic_wallet::bindings::miden::base::types::Asset as wit_bindgen::WasmResource>::drop::drop
    )
    (func $miden:basic-wallet/basic-wallet@1.0.0#send-asset (;6;) (type 2) (param i32 i64 i64 i64 i64 i64)
      call $wit_bindgen::rt::run_ctors_once
      local.get 0
    ...
    (func $__rust_alloc (;7;) (type 4) (param i32 i32) (result i32)
      (local i32)
      local.get 0
      local.get 1
      call $__rdl_alloc
    ...
    (func $__rust_realloc (;8;) (type 5) (param i32 i32 i32 i32) (result i32)
      (local i32)
      local.get 0
      local.get 1
      local.get 2
    ...
    (func $wit_bindgen::rt::run_ctors_once (;9;) (type 3)
      block ;; label = @1
        i32.const 0
    ...
    (func $__rdl_alloc (;11;) (type 4) (param i32 i32) (result i32)
      block ;; label = @1
        block ;; label = @2
          local.get 1
          i32.const 8
    ...
    (func $__rdl_realloc (;12;) (type 5) (param i32 i32 i32 i32) (result i32)
      block ;; label = @1
        block ;; label = @2
          local.get 2
          i32.const 8
    ...
    (func $malloc (;13;) (type 0) (param i32) (result i32)
      local.get 0
      call $dlmalloc
    )
    (func $dlmalloc (;14;) (type 0) (param i32) (result i32)
    ...
    (func $free (;15;) (type 1) (param i32)
      local.get 0
      call $dlfree
    )
    (func $dlfree (;16;) (type 1) (param i32)
    ...
    (func $realloc (;17;) (type 4) (param i32 i32) (result i32)
      (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
      block ;; label = @1
        local.get 0
        br_if 0 (;@1;)
    ...
    (func $dispose_chunk (;18;) (type 6) (param i32 i32)
    ...
    (func $internal_memalign (;19;) (type 4) (param i32 i32) (result i32)
    ...
    (func $aligned_alloc (;20;) (type 4) (param i32 i32) (result i32)
      block ;; label = @1
        local.get 0
        i32.const 16
        i32.gt_u
    ...
    (func $abort (;21;) (type 3)
      unreachable
      unreachable
    )
    (func $sbrk (;22;) (type 0) (param i32) (result i32)
      block ;; label = @1
        local.get 0
        br_if 0 (;@1;)
        memory.size
    ...
    (func $memcpy (;23;) (type 7) (param i32 i32 i32) (result i32)
  ...
  (alias export 1 "add-asset" (func (;0;)))
  (core func (;0;) (canon lower (func 0)))
  (alias export 1 "remove-asset" (func (;1;)))
  ...
  (core func (;3;) (canon resource.drop 5))
  (core instance (;1;)
    (export "[resource-drop]asset" (func 3))
  )
  (core instance (;2;) (instantiate 0
      (with "miden:base/tx-kernel@1.0.0" (instance 0))
  ...
  (export (;3;) (interface "miden:base/account@1.0.0") (instance 2))
  (alias export 0 "asset" (type (;6;)))
  (type (;7;) (own 6))
  (type (;8;) (func (param "asset" 7)))
  (alias core export 2 "miden:basic-wallet/basic-wallet@1.0.0#receive-asset" (core func (;5;)))
  (func (;3;) (type 8) (canon lift (core func 5)))
  (alias export 0 "tag" (type (;9;)))
  (alias export 0 "recipient" (type (;10;)))
  (type (;11;) (func (param "asset" 7) (param "tag" 9) (param "recipient" 10)))
  (alias core export 2 "miden:basic-wallet/basic-wallet@1.0.0#send-asset" (core func (;6;)))
  (func (;4;) (type 11) (canon lift (core func 6)))
  (alias export 0 "asset" (type (;12;)))
  (alias export 0 "felt" (type (;13;)))
  (alias export 0 "tag" (type (;14;)))
  (alias export 0 "word" (type (;15;)))
  (alias export 0 "recipient" (type (;16;)))
  (component (;1;)
    (import "import-type-asset" (type (;0;) (sub resource)))
    (type (;1;) u64)
    (import "import-type-felt" (type (;2;) (eq 1)))
    (import "import-type-tag" (type (;3;) (eq 2)))
    (type (;4;) (tuple 2 2 2 2))
    (import "import-type-word" (type (;5;) (eq 4)))
    (import "import-type-recipient" (type (;6;) (eq 5)))
    (import "import-type-asset0" (type (;7;) (eq 0)))
    (type (;8;) (own 7))
    (type (;9;) (func (param "asset" 8)))
    (import "import-func-receive-asset" (func (;0;) (type 9)))
    (import "import-type-tag0" (type (;10;) (eq 3)))
    (import "import-type-recipient0" (type (;11;) (eq 6)))
    (type (;12;) (func (param "asset" 8) (param "tag" 10) (param "recipient" 11)))
    (import "import-func-send-asset" (func (;1;) (type 12)))
    (export (;13;) "asset" (type 0))
    (export (;14;) "tag" (type 3))
    (export (;15;) "recipient" (type 6))
    (type (;16;) (own 13))
    (type (;17;) (func (param "asset" 16)))
    (export (;2;) "receive-asset" (func 0) (func (type 17)))
    (type (;18;) (func (param "asset" 16) (param "tag" 14) (param "recipient" 15)))
    (export (;3;) "send-asset" (func 1) (func (type 18)))
  )
  (instance (;4;) (instantiate 1
      ...
      (with "import-type-tag" (type 14))
      (with "import-type-word" (type 15))
      (with "import-type-recipient" (type 16))
      (with "import-type-asset0" (type 6))
      (with "import-type-tag0" (type 9))
      (with "import-type-recipient0" (type 10))
    )
  )
  (export (;5;) (interface "miden:basic-wallet/basic-wallet@1.0.0") (instance 4))
)