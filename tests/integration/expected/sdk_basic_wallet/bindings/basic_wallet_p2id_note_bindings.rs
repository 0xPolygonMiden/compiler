...
pub mod miden {
  pub mod base {
    ...
    pub mod note {
      ...
      pub type CoreAsset = super::super::super::miden::base::core_types::CoreAsset;
      pub type AccountId = super::super::super::miden::base::core_types::AccountId;
      pub type NoteInputs = super::super::super::miden::base::core_types::NoteInputs;
      #[allow(unused_unsafe, clippy::all)]
      ...
      pub fn get_inputs() -> NoteInputs{
        ...
        unsafe {
          ...
          let l3 = *((ptr0 + 16) as *const f64);
          let l4 = *((ptr0 + 24) as *const f64);
          let l5 = *((ptr0 + 32) as *const f64);
          let l6 = *((ptr0 + 40) as *const f64);
          let l7 = *((ptr0 + 48) as *const f64);
          let l8 = *((ptr0 + 56) as *const f64);
          let l9 = *((ptr0 + 64) as *const f64);
          let l10 = *((ptr0 + 72) as *const f64);
          let l11 = *((ptr0 + 80) as *const f64);
          let l12 = *((ptr0 + 88) as *const f64);
          let l13 = *((ptr0 + 96) as *const f64);
          let l14 = *((ptr0 + 104) as *const f64);
          let l15 = *((ptr0 + 112) as *const f64);
          let l16 = *((ptr0 + 120) as *const f64);
          (super::super::super::miden::base::core_types::Felt{
            inner: l1,
          }, super::super::super::miden::base::core_types::Felt{
            inner: l2,
