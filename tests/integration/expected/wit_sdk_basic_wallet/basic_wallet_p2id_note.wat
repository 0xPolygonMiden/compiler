(component
  ...
  (core module (;0;)
    ...
    (func $core::ptr::drop_in_place<u64> (;8;) (type 2) (param i32))
    (func $core::ptr::drop_in_place<&basic_wallet_p2id_note::bindings::miden::base::core_types::AccountId> (;9;) (type 2) (param i32))
    (func $core::panicking::assert_failed (;10;) (type 7) (param i32 i32 i32)
      (local i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $rust_begin_unwind (;11;) (type 2) (param i32)
      loop ;; label = @1
        br 0 (;@1;)
      end
    )
    (func $<basic_wallet_p2id_note::bindings::miden::base::core_types::Felt as core::fmt::Debug>::fmt (;12;) (type 1) (param i32 i32) (result i32)
      (local i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $__rust_alloc (;13;) (type 1) (param i32 i32) (result i32)
      i32.const 1049284
      local.get 1
      local.get 0
      call $<wee_alloc::WeeAlloc as core::alloc::global::GlobalAlloc>::alloc
    )
    (func $__rust_realloc (;14;) (type 8) (param i32 i32 i32 i32) (result i32)
      (local i32)
      block ;; label = @1
        i32.const 1049284
        local.get 2
    ...
    (func $miden:base/note-script@1.0.0#note-script (;15;) (type 6)
    ...
    (func $cabi_realloc_wit_bindgen_0_28_0 (;16;) (type 8) (param i32 i32 i32 i32) (result i32)
      block ;; label = @1
        block ;; label = @2
          block ;; label = @3
            block ;; label = @4
    ...
    (func $wit_bindgen_rt::run_ctors_once (;17;) (type 6)
      block ;; label = @1
        i32.const 0
        ...
        i32.const 0
        i32.const 1
        i32.store8 offset=1049289
      end
    )
    (func $wee_alloc::alloc_first_fit (;18;) (type 0) (param i32 i32 i32) (result i32)
    ...
    (func $<wee_alloc::WeeAlloc as core::alloc::global::GlobalAlloc>::alloc (;19;) (type 0) (param i32 i32 i32) (result i32)
      (local i32 i32 i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $<wee_alloc::WeeAlloc as core::alloc::global::GlobalAlloc>::dealloc (;20;) (type 9) (param i32 i32 i32 i32)
      (local i32 i32 i32 i32 i32 i32 i32)
      block ;; label = @1
        local.get 1
        i32.eqz
    ...
    (func $core::ptr::drop_in_place<char> (;21;) (type 2) (param i32))
    (func $core::ptr::drop_in_place<core::fmt::Error> (;22;) (type 2) (param i32))
    (func $core::panicking::panic_fmt (;23;) (type 10) (param i32 i32)
      (local i32)
      global.get $__stack_pointer
      i32.const 32
      i32.sub
    ...
    (func $core::slice::index::slice_start_index_len_fail (;24;) (type 7) (param i32 i32 i32)
      local.get 0
      local.get 1
      local.get 2
      call $core::slice::index::slice_start_index_len_fail_rt
      unreachable
    )
    (func $core::panicking::panic_bounds_check (;25;) (type 7) (param i32 i32 i32)
      (local i32 i64)
      global.get $__stack_pointer
      i32.const 48
      i32.sub
    ...
    (func $core::fmt::Formatter::pad (;26;) (type 0) (param i32 i32 i32) (result i32)
    ...
    (func $core::fmt::num::imp::<impl core::fmt::Display for u32>::fmt (;27;) (type 1) (param i32 i32) (result i32)
      local.get 0
      i64.load32_u
      i32.const 1
      local.get 1
    ...
    (func $core::fmt::write (;28;) (type 0) (param i32 i32 i32) (result i32)
    ...
    (func $<&T as core::fmt::Display>::fmt (;31;) (type 1) (param i32 i32) (result i32)
      local.get 1
      local.get 0
      i32.load
      local.get 0
    ...
    (func $core::panicking::assert_failed_inner (;32;) (type 12) (param i32 i32 i32 i32 i32 i32 i32)
      (local i32 i64)
      global.get $__stack_pointer
      i32.const 112
      i32.sub
    ...
    (func $<&T as core::fmt::Debug>::fmt (;33;) (type 1) (param i32 i32) (result i32)
      local.get 0
      i32.load
      local.get 1
      local.get 0
    ...
    (func $<core::fmt::Arguments as core::fmt::Display>::fmt (;34;) (type 1) (param i32 i32) (result i32)
      local.get 1
      i32.load offset=20
      local.get 1
      i32.load offset=24
    ...
    (func $<core::fmt::builders::PadAdapter as core::fmt::Write>::write_str (;35;) (type 0) (param i32 i32 i32) (result i32)
    ...
    (func $<core::fmt::builders::PadAdapter as core::fmt::Write>::write_char (;36;) (type 1) (param i32 i32) (result i32)
      (local i32 i32)
      local.get 0
      i32.load offset=4
      local.set 2
    ...
    (func $core::fmt::builders::DebugStruct::finish (;37;) (type 13) (param i32) (result i32)
      (local i32 i32)
      local.get 0
      i32.load8_u offset=4
      local.set 1
    ...
    (func $core::fmt::Formatter::pad_integral (;38;) (type 14) (param i32 i32 i32 i32 i32 i32) (result i32)
      (local i32 i32 i32 i32 i32 i32 i32)
      block ;; label = @1
        block ;; label = @2
          local.get 1
    ...
    (func $core::fmt::Write::write_fmt (;39;) (type 1) (param i32 i32) (result i32)
      local.get 0
      i32.const 1048928
      local.get 1
      call $core::fmt::write
    )
    (func $core::str::count::do_count_chars (;40;) (type 1) (param i32 i32) (result i32)
    ...
    (func $core::fmt::Formatter::pad_integral::write_prefix (;41;) (type 11) (param i32 i32 i32 i32 i32) (result i32)
      (local i32)
      block ;; label = @1
        block ;; label = @2
          block ;; label = @3
    ...
    (func $core::fmt::Formatter::debug_struct (;42;) (type 9) (param i32 i32 i32 i32)
      local.get 1
      i32.load offset=20
      local.get 2
      local.get 3
    ...
    (func $core::slice::index::slice_start_index_len_fail_rt (;43;) (type 7) (param i32 i32 i32)
      (local i32 i64)
      global.get $__stack_pointer
      i32.const 48
      i32.sub
    ...
    (func $core::fmt::num::imp::<impl core::fmt::Display for u64>::fmt (;44;) (type 1) (param i32 i32) (result i32)
      local.get 0
      i64.load
      i32.const 1
      local.get 1
    ...
    (func $core::fmt::num::imp::fmt_u64 (;45;) (type 15) (param i64 i32 i32) (result i32)
    ...
    (func $core::fmt::num::<impl core::fmt::LowerHex for i64>::fmt (;46;) (type 1) (param i32 i32) (result i32)
      (local i32 i64 i32)
      global.get $__stack_pointer
      i32.const 128
      i32.sub
    ...
    (func $core::fmt::num::<impl core::fmt::UpperHex for i64>::fmt (;47;) (type 1) (param i32 i32) (result i32)
      (local i32 i64 i32)
      global.get $__stack_pointer
      i32.const 128
      i32.sub
    ...
    (func $cabi_realloc (;48;) (type 8) (param i32 i32 i32 i32) (result i32)
      local.get 0
      local.get 1
      local.get 2
      local.get 3
