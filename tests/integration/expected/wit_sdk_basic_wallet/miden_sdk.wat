(component
  (core module (;0;)
    ...
    (func $__rust_alloc (;1;) (type 1) (param i32 i32) (result i32)
      i32.const 1048580
      local.get 1
      local.get 0
      call $<wee_alloc::WeeAlloc as core::alloc::global::GlobalAlloc>::alloc
    )
    (func $__rust_realloc (;2;) (type 2) (param i32 i32 i32 i32) (result i32)
      (local i32)
      block ;; label = @1
        i32.const 1048580
        local.get 2
    ...
    (func $miden:base/core-types@1.0.0#account-id-from-felt (;3;) (type 3) (param i64) (result i64)
      call $wit_bindgen_rt::run_ctors_once
      local.get 0
    )
    (func $miden:base/types@1.0.0#from-core-asset (;4;) (type 4) (param i64 i64 i64 i64) (result i32)
      call $wit_bindgen_rt::run_ctors_once
      unreachable
      unreachable
    )
    (func $miden:base/types@1.0.0#to-core-asset (;5;) (type 5) (param i32 i64 i64 i64 i64) (result i32)
      call $wit_bindgen_rt::run_ctors_once
      unreachable
      unreachable
    )
    ...
    (func $wit_bindgen_rt::run_ctors_once (;7;) (type 0)
      block ;; label = @1
        i32.const 0
