(module $miden_sdk_account_test.wasm
  ...
  (import "miden:types/felt" "as_u64" (func $miden_sdk_types::felt::extern_as_u64 (;5;) (type 5)))
  ...
  (func $note_script (;11;) (type 0) (result f64)
    ...
    local.tee 2
    call $miden_sdk_types::felt::Felt::as_u64
    local.set 3
    local.get 2
    call $miden_sdk_types::felt::Felt::as_u64
    local.set 4
  ...
  (func $miden_sdk_types::felt::Felt::as_u64 (;16;) (type 5) (param f64) (result i64)
    local.get 0
    call $miden_sdk_types::felt::extern_as_u64
  )
  (func $miden_sdk_types::word::Word::from_u64_unchecked (;17;) (type 10) (param i32 i64 i64 i64 i64)
    (local f64 f64 f64)
    local.get 1
    call $miden_sdk_types::felt::extern_from_u64_unchecked
    local.set 5
