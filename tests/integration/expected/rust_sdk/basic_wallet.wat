(component
  ...
  (type (;7;)
    (instance
      ...
      (export (;0;) "blake3-hash-one-to-one" (func (type 2)))
    )
  )
  (import "miden:core-import/stdlib-crypto-hashes@1.0.0" (instance (;4;) (type 7)))
  ...
  (core module (;0;)
    ...
    (import "miden:core-import/stdlib-crypto-hashes@1.0.0" "blake3-hash-one-to-one" (func $miden_stdlib_sys::stdlib::crypto::hashes::extern_blake3_hash_1to1 (;1;) (type 1)))
  ...
  (alias export 4 "blake3-hash-one-to-one" (func (;1;)))
  (core func (;1;) (canon lower (func 1)))
  (core instance (;1;)
    (export "blake3-hash-one-to-one" (func 1))
  )
  ...
  (core instance (;5;) (instantiate 0
      ...
      (with "miden:core-import/stdlib-crypto-hashes@1.0.0" (instance 1))
