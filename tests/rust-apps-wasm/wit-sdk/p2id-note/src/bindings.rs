...
pub mod exports {
    ...
    pub mod miden {
        ...
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
          ...
          unsafe extern "C" fn export_note_script() {
            $($path_to_types)*::_export_note_script_cabi::<$ty>()
          }
        };);
      }
                #[doc(hidden)]
...
macro_rules! __export_notes_world_impl {
  ...
  $($path_to_types_root)*::exports::miden::base::note_script::__export_miden_base_note_script_1_0_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::miden::base::note_script);
  )
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.25.0:notes-world:encoded world"]
#[doc(hidden)]
