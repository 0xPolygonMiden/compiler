...
pub mod exports {
    ...
    pub mod miden {
        ...
        pub mod base {
            ...
            pub mod core_types {
                ...
                /// The backing type is `f64` but the internal values are always integer in the
                /// range [0, M). Field modulus M = 2^64 - 2^32 + 1
                #[repr(C)]
                #[derive(Clone, Copy)]
                pub struct Felt {
                    /// We plan to use f64 as the backing type for the field element. It has the
                    /// size that we need and we don't plan to support floating
                    /// point arithmetic in programs for Miden VM.
                    ///
                    /// For now its u64
                    pub inner: u64,
                }
                ...
                /// - 1 - only the account hash is stored on-chain which serves as a commitment to
                ///   the account state.
                ...
                /// which issued the asset. This guarantees the properties described
                /// above (the first bit is ONE).
                ///
                /// The least significant element is set to the amount of the asset. This amount
                /// cannot be greater than 2^63 - 1 and thus requires 63-bits to
                /// store.
                ///
                /// Elements 1 and 2 are set to ZERO.
                ///
                /// It is impossible to find a collision between two fungible assets issued by
                /// different faucets as the faucet_id is included in the
                /// description of the asset and this is guaranteed to be different
                /// for each faucet as per the faucet creation logic.
                ///
                /// # Non-fungible assets
                /// The 4 elements of non-fungible assets are computed as follows:
                /// - First the asset data is hashed. This compresses an asset of an arbitrary
                ///   length to 4 field
                /// elements: [d0, d1, d2, d3].
                /// - d1 is then replaced with the faucet_id which issues the asset: [d0, faucet_id,
                ///   d2, d3].
                ...
                /// different faucets as the faucet_id is included in the
                /// description of the non-fungible asset and this is guaranteed
                /// to be different as per the faucet creation logic. Collision resistance for
                /// non-fungible assets issued by the same faucet is ~2^95.
                #[repr(C)]
                #[derive(Clone, Copy)]
                ...
                pub unsafe fn _export_account_id_from_felt_cabi<T: Guest>(arg0: i64) -> i64 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
        ...
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
          ...
          unsafe extern "C" fn export_account_id_from_felt(arg0: i64,) -> i64 {
            $($path_to_types)*::_export_account_id_from_felt_cabi::<$ty>(arg0)
          }
        };);
      }
                #[doc(hidden)]
            ...
            pub mod types {
                ...
                ///
                /// A non-fungible asset consists of 4 field elements which are computed by hashing
                /// asset data (which can be of arbitrary length) to produce: [d0,
                /// d1, d2, d3].  We then replace d1 with the faucet_id that issued
                /// the asset: [d0, faucet_id, d2, d3]. We then set the most significant bit
                ...
                impl ::core::fmt::Debug for NonFungibleAsset {
                    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                        f.debug_struct("NonFungibleAsset").field("inner", &self.inner).finish()
                    }
                }
                /// A fungible or a non-fungible asset.
                #[derive(Clone, Copy)]
    ...
    ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
      ...
      unsafe extern "C" fn export_from_core_asset(arg0: i64,arg1: i64,arg2: i64,arg3: i64,) -> *mut u8 {
        $($path_to_types)*::_export_from_core_asset_cabi::<$ty>(arg0, arg1, arg2, arg3)
      }
      #[export_name = "miden:base/types@1.0.0#to-core-asset"]
      unsafe extern "C" fn export_to_core_asset(arg0: i32,arg1: i64,arg2: i64,arg3: i64,arg4: i64,) -> *mut u8 {
        $($path_to_types)*::_export_to_core_asset_cabi::<$ty>(arg0, arg1, arg2, arg3, arg4)
      }
    };);
  }
                #[doc(hidden)]
...
macro_rules! __export_base_world_impl {
  ...
  $($path_to_types_root)*::exports::miden::base::core_types::__export_miden_base_core_types_1_0_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::miden::base::core_types);
  $($path_to_types_root)*::exports::miden::base::types::__export_miden_base_types_1_0_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::miden::base::types);
  )
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.25.0:base-world:encoded world"]
#[doc(hidden)]
