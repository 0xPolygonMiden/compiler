    ...
    pub mod base {
        ...
        pub mod account {
            ...
            pub type AccountCodeRoot =
                super::super::super::miden::base::core_types::AccountCodeRoot;
            pub type VaultCommitment =
            ...
            pub fn get_id() -> AccountId {
                ...
                unsafe {
                    ...
                    super::super::super::miden::base::core_types::AccountId {
                        inner: super::super::super::miden::base::core_types::Felt { inner: ret },
                    }
                }
            }
            #[allow(unused_unsafe, clippy::all)]
            ...
            pub fn get_initial_hash() -> AccountHash {
                ...
                unsafe {
                    ...
                    super::super::super::miden::base::core_types::AccountHash {
                        inner: (
                            super::super::super::miden::base::core_types::Felt { inner: l1 },
                            super::super::super::miden::base::core_types::Felt { inner: l2 },
                            super::super::super::miden::base::core_types::Felt { inner: l3 },
                            super::super::super::miden::base::core_types::Felt { inner: l4 },
                        ),
                    }
                }
            }
            ...
            pub fn incr_nonce(value: Felt) {
                ...
                use wit_bindgen::rt::{alloc, string::String, vec::Vec};
                unsafe {
                    let super::super::super::miden::base::core_types::Felt { inner: inner0 } =
                        value;
                ...
                unsafe {
                    ...
                    super::super::super::miden::base::core_types::StorageValue {
                        inner: (
                            ...
                            super::super::super::miden::base::core_types::Felt { inner: l3 },
                            super::super::super::miden::base::core_types::Felt { inner: l4 },
                            super::super::super::miden::base::core_types::Felt { inner: l5 },
                        ),
                    }
                }
            }
            ...
            pub fn set_item(index: Felt, value: StorageValue) -> (StorageRoot, StorageValue) {
                ...
                unsafe {
                    ...
                    wit_import(
                        wit_bindgen::rt::as_f64(inner0),
                        wit_bindgen::rt::as_f64(inner3),
                        wit_bindgen::rt::as_f64(inner4),
                        wit_bindgen::rt::as_f64(inner5),
                        wit_bindgen::rt::as_f64(inner6),
                        ptr7,
                    );
                    ...
                    (
                        super::super::super::miden::base::core_types::StorageRoot {
                            inner: (
                                super::super::super::miden::base::core_types::Felt { inner: l8 },
                                super::super::super::miden::base::core_types::Felt { inner: l9 },
                                super::super::super::miden::base::core_types::Felt { inner: l10 },
                                super::super::super::miden::base::core_types::Felt { inner: l11 },
                            ),
                        },
                        super::super::super::miden::base::core_types::StorageValue {
                            inner: (
                                super::super::super::miden::base::core_types::Felt { inner: l12 },
                                super::super::super::miden::base::core_types::Felt { inner: l13 },
                                super::super::super::miden::base::core_types::Felt { inner: l14 },
                                super::super::super::miden::base::core_types::Felt { inner: l15 },
                            ),
                        },
                    )
                }
            ...
            pub fn get_balance(account_id: AccountId) -> Felt {
                ...
                use wit_bindgen::rt::{alloc, string::String, vec::Vec};
                unsafe {
                    let super::super::super::miden::base::core_types::AccountId { inner: inner0 } =
                        account_id;
                    let super::super::super::miden::base::core_types::Felt { inner: inner1 } =
                        inner0;
                    ...
                    super::super::super::miden::base::core_types::Felt { inner: ret }
                }
            }
            #[allow(unused_unsafe, clippy::all)]
            ...
            pub fn has_non_fungible_asset(asset: CoreAsset) -> bool {
                ...
                use wit_bindgen::rt::{alloc, string::String, vec::Vec};
                unsafe {
                    let super::super::super::miden::base::core_types::CoreAsset { inner: inner0 } =
                        asset;
                    let (t1_0, t1_1, t1_2, t1_3) = inner0;
                    let super::super::super::miden::base::core_types::Felt { inner: inner2 } = t1_0;
                    let super::super::super::miden::base::core_types::Felt { inner: inner3 } = t1_1;
            ...
            pub fn add_asset(asset: CoreAsset) -> CoreAsset {
                ...
                unsafe {
                    ...
                    super::super::super::miden::base::core_types::CoreAsset {
                        inner: (
                            super::super::super::miden::base::core_types::Felt { inner: l7 },
                            super::super::super::miden::base::core_types::Felt { inner: l8 },
                            super::super::super::miden::base::core_types::Felt { inner: l9 },
                            super::super::super::miden::base::core_types::Felt { inner: l10 },
                        ),
        ...
        pub mod tx {
            ...
            pub fn create_note(asset: CoreAsset, tag: Tag, recipient: Recipient) -> NoteId {
                ...
                unsafe {
                    ...
                    let super::super::super::miden::base::core_types::Felt { inner: inner7 } =
                        inner6;
                    let super::super::super::miden::base::core_types::Recipient { inner: inner8 } =
                        recipient;
                    let (t9_0, t9_1, t9_2, t9_3) = inner8;
                    let super::super::super::miden::base::core_types::Felt { inner: inner10 } =
                        t9_0;
                    let super::super::super::miden::base::core_types::Felt { inner: inner11 } =
                        t9_1;
                    let super::super::super::miden::base::core_types::Felt { inner: inner12 } =
                        t9_2;
                    let super::super::super::miden::base::core_types::Felt { inner: inner13 } =
                        t9_3;
                    ...
                    let ret = wit_import(
                        ...
                        wit_bindgen::rt::as_f64(inner4),
                        wit_bindgen::rt::as_f64(inner5),
                        wit_bindgen::rt::as_f64(inner7),
                        wit_bindgen::rt::as_f64(inner10),
                        wit_bindgen::rt::as_f64(inner11),
                        wit_bindgen::rt::as_f64(inner12),
                        wit_bindgen::rt::as_f64(inner13),
                    );
        ...
        pub mod basic_wallet {
            ...
            pub mod basic_wallet {
                ...
                const _: () = {
                    ...
                    unsafe extern "C" fn __export_receive_asset(
                        arg0: f64,
                        arg1: f64,
                        arg2: f64,
                        arg3: f64,
                        ...
                        <_GuestImpl as Guest>::receive_asset(
                ...
                const _: () = {
                    ...
                    #[allow(non_snake_case)]
                    unsafe extern "C" fn __export_send_asset(
                        arg0: f64,
                        arg1: f64,
                        arg2: f64,
                        arg3: f64,
                        ...
                        <_GuestImpl as Guest>::send_asset(
                            super::super::super::super::miden::base::core_types::CoreAsset {
                                inner: (
                                    super::super::super::super::miden::base::core_types::Felt {
                                        inner: arg0,
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8;