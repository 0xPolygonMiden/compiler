...
#[test]
fn rust_add() {
    let mut test = CompilerTest::rust_source(include_str!("rust_source/add.rs"));
...
#[test]
fn rust_fib() {
    let mut test = CompilerTest::rust_source(include_str!("rust_source/fib.rs"));
...
#[test]
fn rust_enum() {
    let mut test = CompilerTest::rust_source(include_str!("rust_source/enum.rs"));
...
#[test]
fn rust_array() {
    let mut test = CompilerTest::rust_source(include_str!("rust_source/array.rs"));
...
#[test]
fn rust_static_mut() {
    let mut test = CompilerTest::rust_source(include_str!("rust_source/static_mut.rs"));
