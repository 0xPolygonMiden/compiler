...
//! becoming a full-fledged `LinearComponent`. The main purpose for the existence of
...
pub struct ComponentDfg {
    ...
    /// All trampolines and their type signature
...
impl ComponentDfg {
    /// Consumes the intermediate `ComponentDfg` to produce a final `LinearComponent`
    /// with a linear innitializer list.
    pub fn finish(self) -> LinearComponentTranslation {
        ...
        // linearization are recorded into the `LinearComponent`. The number of
