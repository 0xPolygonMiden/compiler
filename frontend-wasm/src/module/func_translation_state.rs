...
//!
//! The `FuncTranslationState` struct defined in this module is used to keep track of the
//! WebAssembly value and control stacks during the translation of a single function.
//!
